...
class override_AssetRepair(AccountsController):
    def validate(self):
    ...
    def update_status(self):
        if self.repair_status == "Pending":
            ...
            frappe.db.set_value("Asset", self.asset, "condition", "NOT OK")

        elif self.repair_status == "Damage":
            frappe.db.set_value("Asset", self.asset, "status", "Out of Order")
            frappe.db.set_value("Asset", self.asset, "condition", "DAMAGE")

        elif self.repair_status == "Disposal":
            frappe.db.set_value("Asset", self.asset, "status", "Out of Order")
            frappe.db.set_value("Asset", self.asset, "condition", "DISPOSAL")

        else:
            frappe.db.set_value("Asset", self.asset, "condition", "OK")
    ...
    def check_repair_status(self):
        if self.repair_status in ["Pending","Damage","Disposal"]:
